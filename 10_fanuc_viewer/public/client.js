...
load_geometries().then(()=>{
    ...
    offsets.push(new THREE.Group());
    offsets[4].position.set(1.54869-1.31519, 0, 0.087150-0.00015);
    ...
    socket.on("joint_values", (joint_values) =>{
        ...
        joints[5].rotation.set(0, 0, THREE.Math.degToRad(joint_values[4]),0);
    ...
    //joints[2].rotation.set(0,0,THREE.Math.degToRad(90));
